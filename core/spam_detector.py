...
4. **私下拉人的訊息**（如「加我 LINE」「私聊帶單」「聯繫我微信」「telegram 私訊」）
5. **過度推銷的訊息**（如「包賺不賠」「跟單保證獲利」「穩賺方法」「100% 勝率」「超賺」「爽收U」「拿下一套房」「輕鬆賺錢」「跟上就賺」等誇大收益、承諾暴利的話術）
6. **無關主題的廣告**（如賣產品、其他服務推銷、色情、賭博）
7. **跨群組回覆訊息**（訊息內容看起來像是在回覆某個不存在於本群組的訊息，例如 Ella 之類的人名但群組裡沒有這個人）
8. **惡意洗版、騷擾性訊息、辱罵**
